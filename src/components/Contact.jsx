    ...
    <section id="contact" className="py-12 bg-gray-100">
      <div className="container mx-auto px-4">
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-gray-600">Expand your business horizons with Avinya's unparalleled expertise! Contact us now to embark on your journey to success in the Indian market.</p>
        </div>
        ...
        <div className="flex flex-col md:flex-row gap-2">
          ...
          <div className="md:w-1/4">
            <div className="bg-white p-4 rounded-lg shadow-md">
              ...
              <p className="mt-2 text-gray-600">+91 96240 73799</p>
            </div>
          </div>
        </div>
